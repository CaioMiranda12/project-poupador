...
export function PieChartDespesaByUtilidade({ data }) {
  ...
  return (
    <PieChart width={400} height={400}>
      <Pie
        ...
        outerRadius={60}
        fill="#8884d8"
        label={(entry) => `${entry.utilidade}: ${entry.percentage}%`}
        labelLine={false}
      >
...
PieChartDespesaByUtilidade.propTypes = {
  data: PropTypes.arrayOf(
    PropTypes.shape({
      utilidade: PropTypes.string.isRequired,
